<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		<div class="flex-w p-b-90">
			...
			<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
				...
				<ul>
					<li class="p-b-9">
						<a href="book" class="s-text7">
							Books
						</a>
					</li>

					<li class="p-b-9">
						<a href="author" class="s-text7">
							Author
						</a>
					</li>

					<li class="p-b-9">
						<a href="publication" class="s-text7">
							Publication
						</a>
					</li>
				</ul>
			...
			<div class="w-size8 p-t-30 p-l-15 p-r-15 respon3">
				...
				<form>
					<div class="effect1 w-size9">
						<input class="s-text7 bg6 w-full p-b-5" type="text" name="email" placeholder="rokomari.com@example.com">
		...
		<div class="t-center p-l-15 p-r-15">
			...
			<div class="t-center s-text8 p-t-20">
				Copyright © 2019 All rights reserved. | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Stack</a>
			</div>
		</div>
	</footer>
