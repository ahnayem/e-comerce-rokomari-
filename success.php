...
<head>
	<meta charset="UTF-8">
	<title>Rokomari||Mail Conformation</title>
	<meta charset="UTF-8">
...
<section>
	<div class="mail-conformed text-center">
		<div class="success-icon">
			<i class="fa fa-envelope-open-o"></i>
		</div>
		<div class="success-text">
			<h2>Hello User, You Account is activated</h2>
			<h4>Please signin to user your account</h4>
